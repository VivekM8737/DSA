...
public class printSingleChildPrent {
    ...
    public static void printParent(Node n){
        if(n==null){
            return;
        }
        if(n.lch==null && n.rch!=null){
            System.out.println(n.rch.data);
        }
        else if(n.rch==null && n.lch!=null){
            System.out.println(n.lch.data);
        }
        printParent(n.lch);
        printParent(n.rch);
    }
