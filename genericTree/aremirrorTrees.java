...
public class aremirrorTrees {
    private static boolean mirrorcheck(Node node,Node node2){
    ...
    public static void main(String[] args) {
        int[] arr = { 10, 20, 50, -1, -1, 30, 70, -1, 80, 110, -1, 120, -1, -1, 90, -1, -1, 40, 100, -1, -1,
            -1 };
        int[] arr2 = { 5, 20, 50, -1, -1, 30, 70, -1, 80, 110, -1, 120, -1, -1, 90, -1, -1, 40,51,-1, -1,
            -1 };
        ...
        System.out.println("");
        display(t2);
        System.out.println(mirrorcheck(t1, t2));
